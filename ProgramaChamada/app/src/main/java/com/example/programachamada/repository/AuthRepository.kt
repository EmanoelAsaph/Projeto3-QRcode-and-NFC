...
import com.amplifyframework.kotlin.core.Amplify as AmplifyKotlin
                ...
                Amplify.Auth.signOut(
                    {
                        ...
                        continuation.resume(AuthResult.Success("Logout realizado"))
                    },
                    { error ->
                        Log.e(TAG, "Erro no logout: ${error.message}", error)
                        continuation.resume(
                            AuthResult.Error(
